...
const MyPageEditScreen = () => {
    ...
    const handleContactPress = () => {
        router.push('boss/boss.modification/change_contactscreen'); 
    };
    const handlePasswordPress = () => {
        router.push('boss/boss.modification/change_passwordscreen'); 
    };
    const handleAddressPress = () => {
        router.push('boss/boss.modification/change_addressscreen'); 
    };
