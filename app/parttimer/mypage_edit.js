...
const MyPageEdit = () => {
    ...
    const handleContactPress = () => {
        router.push('parttimer/edit/change_contact'); 
    };
    const handlePasswordPress = () => {
        router.push('parttimer/edit/change_password'); 
    };
    const handleAddressPress = () => {
        router.push('parttimer/edit/change_address'); 
    };
    const handleBaroTIPress = () => {
        router.push('login/propensity'); 
    };
    const handleAmountPress = () => {
        router.push('parttimer/edit/set_amount'); 
    };
    const handleTimePress = () => {
        router.push('parttimer/edit/set_preferred_time'); 
    };
